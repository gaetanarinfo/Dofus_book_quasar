...
async function start () {
  ...
  const bootFiles = [qboot_Bootcompositionapi,qboot_Bootaxios,qboot_Quasarquasarappextensionqmediaplayersrcbootregisterjs,qboot_Quasarquasarappextensionqiconpickersrcbootregisterjs]
